...
module @jit__linspace.34 {
  func @foo(%arg0: tensor<i64>, %arg1: tensor<i64>) -> tensor<100xf64> {
    ...
    %22 = linalg.fill(%cst_8, %21) : f64, tensor<100xf64> -> tensor<100xf64>
  ...
  func @main() {
    ...
    %2 = call @foo(%0, %1) : (tensor<i64>, tensor<i64>) -> tensor<100xf64>
