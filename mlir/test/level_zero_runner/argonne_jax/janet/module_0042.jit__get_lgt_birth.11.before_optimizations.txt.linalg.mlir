...
#map2 = affine_map<() -> ()>
module @jit__get_lgt_birth.11 {
  func @foo(%arg0: tensor<f32>, %arg1: tensor<95xf32>) -> tensor<95xf32> {
    %cst = arith.constant dense<1.000000e+01> : tensor<95xf32>
    %cst_0 = arith.constant dense<1.000000e-03> : tensor<95xf32>
    %cst_1 = arith.constant dense<1.000000e-03> : tensor<f32>
    %cst_2 = arith.constant dense<1.000000e+01> : tensor<f32>
    ...
    %3 = linalg.generic {indexing_maps = [#map1, #map1, #map1], iterator_types = ["parallel"]} ins(%cst, %arg1 : tensor<95xf32>, tensor<95xf32>) outs(%2 : tensor<95xf32>) {
    ...
    %7 = linalg.generic {indexing_maps = [#map1, #map1, #map1], iterator_types = ["parallel"]} ins(%5, %cst_0 : tensor<95xf32>, tensor<95xf32>) outs(%6 : tensor<95xi1>) {
    ^bb0(%arg2: f32, %arg3: f32, %arg4: i1):
      %17 = arith.cmpf olt, %arg2, %arg3 : f32
      linalg.yield %17 : i1
    } -> tensor<95xi1>
    %8 = call @jit__where.13(%7, %cst_1, %5) : (tensor<95xi1>, tensor<f32>, tensor<95xf32>) -> tensor<95xf32>
    ...
    %12 = linalg.generic {indexing_maps = [#map2, #map2], iterator_types = []} ins(%cst_2 : tensor<f32>) outs(%11 : tensor<f32>) {
    ^bb0(%arg2: f32, %arg3: f32):
      %17 = math.log %arg2 : f32
      linalg.yield %17 : f32
    } -> tensor<f32>
  ...
  func private @jit__where.13(%arg0: tensor<95xi1>, %arg1: tensor<f32>, %arg2: tensor<95xf32>) -> tensor<95xf32> {
    %0 = linalg.init_tensor [95] : tensor<95xf32>
  ...
  func @main() {
    ...
    %1 = arith.constant dense<2.000000e+00> : tensor<95xf32>
    %2 = call @foo(%0, %1) : (tensor<f32>, tensor<95xf32>) -> tensor<95xf32>
    %unranked = tensor.cast %2 : tensor<95xf32> to tensor<*xf32>
